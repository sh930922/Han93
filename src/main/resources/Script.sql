...
(hanja_role_idx_seq.nextval,'bigdata202005@gmail.com','ROLE_ADMIN');
INSERT INTO hanja_ROLES (role_idx,userid,role)  VALUES 
(hanja_role_idx_seq.nextval,'bigdata202005@gmail.com','ROLE_DBA');
INSERT INTO hanja_ROLES (role_idx,userid,role)  VALUES 
(hanja_role_idx_seq.nextval,'bigdata202005@gmail.com','ROLE_USER');
INSERT INTO hanja_ROLES (role_idx,userid,role)  VALUES 
(hanja_role_idx_seq.nextval,'bigdata202005@gmail.com','ROLE_MEMBER');
COMMIT;
SELECT * FROM hanja_roles;
select userid as username, password, use as enabled from hanja where userid='bigdata202005@gmail.com';
select userid as username, role from hanja_roles where userid='bigdata202005@gmail.com';
